...
## BUG
* 目前 “启动器(fast.sh)” 中的制作APP功能在Ubuntu系统上签名有问题，请等待后续版本修复
* 目前 “openvpn udp 53” 端口在Ubuntu系统上被其它程序占用，导致无法正常启动，请等待后续版本修复
* .c安装脚本在判断国家/地区代码来选择DNS的功能似乎有问题，它全部默认选择“8.8.8.8”，请等待后续版本修复
